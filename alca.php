...
$conexion2= conexion2();
$sql3="select codigotipo,nombre
                    from tipos";
            $resul3=mysqli_query($conexion2,$sql3);

?>
         <label>Prueba</label>
        <select id="codigotipo" class="form-control input-sm">
...
require_once "php/conexion.php";
$conexion2= conexion2();
$sql3="select codigosede,ciudad,nombre
                    from sede";
            $resul3=mysqli_query($conexion2,$sql3);
      ...
      <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
           ...
           <select id="idsedeu" class="form-control input-sm" onchange='cambioEmpresa();'>
           <option value="0">Seleciona uno</option>
            <?php
           while($ver1=mysqli_fetch_row($resul3)):
            ?>
        ...
        <select id="idsedeu2" class="form-control input-sm" onchange='cambioEmpresa2();'>
           <option value="0">Seleciona uno</option>
            <?php
           while($ver1=mysqli_fetch_row($resul3)):
            ?>
        ...
        {
           document.getElementById('showtipo').value=document.getElementById('idsedeu').value;
           
        }
        function cambioEmpresa2()
        {
           
           document.getElementById('showsede').value=document.getElementById('idsedeu2').value;
        }
    </script>
 
       <label>tipo 1</label>              
     <input type="text" name="" id="showtipo" class="form-control input-sm">
     <label>sede 2</label>  
