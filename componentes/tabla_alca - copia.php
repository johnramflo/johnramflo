        ...
        <table class="table table-hover table-condensed table-bordered">
           ...
           if(isset($_SESSION['consulta'])){
					if($_SESSION['consulta'] > 0){
						...
						$sql="SELECT alca.codigoalca, alca.primern,alca.segundon,alca.primera,alca.segundoa,tipos.nombre,sede.nombre  FROM alca INNER JOIN sede ON alca.idsede=sede.idsede
