...
<html>
    ...
    <div class="jumbotron p-3 p-md-5 text-warning rounded bg-jarvin">    
          ...
          <CENTER>Tabla dinamica Sedes</center>
      ...
      <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
              ...
              <input type="text" hidden="" id="idsede" name="">
              <label>Nombre</label>
              <input type="text" name=""id="nombreu" class="form-control input-sm">
              <label>Ciudad</label>
              <input type="text" name="" id="ciudadu"class="form-control input-sm">
...
<script type="text/javascript">
 ...
 <script type="text/javascript">
    $(document).ready(function(){
        ...
        agregardatos_sede(nombre,ciudad);
         $('#nombre').val("");  
             $('#ciudad').val(""); 
